      ...
      std::vector<std::string> tags)
{
   ...
   return addJob(id,
         ...
         0, /*started*/
         0, /*completed*/
         name, status, group, rScript, workingDirectory,
         importEnv, exportEnv, progress, state, type,
         "" /*cluster*/,
      ...
      std::vector<std::string> tags)
{
   ...
   boost::shared_ptr<Job> pJob = boost::make_shared<Job>(
         ...
         importEnv, exportEnv, 0 /* completed units */, progress, state, type, cluster,
         autoRemove, actions, show, saveOutput, tags);
